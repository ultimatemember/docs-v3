...
``` php:no-line-numbers
add_action( 'um_stripe_webhook_payload_event_init', 'um_0152024_stripe_webhook_payload_event_init', 10, 1 );
function um_0152024_stripe_webhook_payload_event_init( $event ){
 // do something
}
```
<div class='hook-sep'></div>
