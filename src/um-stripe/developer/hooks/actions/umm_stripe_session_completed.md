...
``` php:no-line-numbers
add_action( 'umm_stripe_session_completed', 'um_0152024_stripe_session_completed', 10, 2 );
function um_0152024_stripe_session_completed( $checkout_session, $payment_mode ){
 // do something
}
```
<div class='hook-sep'></div>
