...
``` php:no-line-numbers
add_action( 'umm_stripe_status_incomplete', 'um_1172023_stripe_status_incomplete', 10, 2 );
function um_1172023_stripe_status_incomplete( $um_user_id, $role_incomplete ){
 // do something
}
```
<div class='hook-sep'></div>
