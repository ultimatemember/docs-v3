...
``` php:no-line-numbers
add_filter( 'umm_stripe_predefined_pages_restricted', 'um_10312023_stripe_predefined_pages_restricted ', 10, 1 )
function um_10312023_stripe_predefined_pages_restricted( $is_restricted_page ){
