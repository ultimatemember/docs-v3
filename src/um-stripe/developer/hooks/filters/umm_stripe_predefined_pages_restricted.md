...
``` php:no-line-numbers
add_filter( 'umm_stripe_predefined_pages_restricted', 'um_12202024_stripe_predefined_pages_restricted', 10, 1 );
function um_12202024_stripe_predefined_pages_restricted( $is_restricted_page ){
