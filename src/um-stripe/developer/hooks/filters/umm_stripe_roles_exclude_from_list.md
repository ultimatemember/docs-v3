...
``` php:no-line-numbers
add_filter( 'umm_stripe_roles_exclude_from_list', 'um_11162023_stripe_roles_exclude_from_list', 10, 1 );
function um_11162023_stripe_roles_exclude_from_list( $um_wp_roles ){
  return $um_wp_roles;
}
```
<div class='hook-sep'></div>
