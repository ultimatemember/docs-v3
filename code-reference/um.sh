...
banner="\
--------------------------------------------------------------------------------
                    ULTIMATE MEMBER CODE REFERENCE GENERATOR
--------------------------------------------------------------------------------"
...
parse_args() {
    ...
    if [[ -z $github_repo ]]; then
        github_repo="ultimatemember/ultimatemember"
    fi
    ...
    deploy_directory=data/templates/ultimatemember/api
    deploy_branch=main
...
download_source() {
    ...
    echo
    curl -LSO# "https://github.com/${github_repo}/archive/refs/tags/${source_version}.zip"
    ...
    # Unzip source code.
     unzip -o "${source_version}.zip" -d .
     rm "${source_version}.zip";
     mv "ultimatemember-${source_version}" "ultimatemember"
...
run_build() {
    ...
    cp "./data/templates/ultimatemember/api/actions.html" "../pages/developer/hooks/actions.mdx"
    cp "./data/templates/ultimatemember/api/filters.html" "../pages/developer/hooks/filters.mdx"
    rm "../pages/developer/hooks/hooks.mdx"
}
