...
``` php:no-line-numbers
add_filter( 'umm_stripe_already_subscribed_text', 'um_10252023_stripe_already_subscribed_text ', 10, 1 )
function um_10252023_stripe_already_subscribed_text( $subscribed_text ){
