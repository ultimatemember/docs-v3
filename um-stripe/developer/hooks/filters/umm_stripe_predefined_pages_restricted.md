...
``` php
add_filter( 'umm_stripe_predefined_pages_restricted', 'um_09272023_stripe_predefined_pages_restricted ', 10, 1 )
function um_09272023_stripe_predefined_pages_restricted( $is_restricted_page ){
