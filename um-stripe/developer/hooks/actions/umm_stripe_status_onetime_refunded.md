...
``` php
add_action( 'umm_stripe_status_onetime_refunded', 'um_1042023_stripe_status_onetime_refunded ', 10, 2 )
function um_1042023_stripe_status_onetime_refunded( $um_user_id, $role_active ){
 // do something
}
```
<div class='hook-sep'></div>
