...
``` php:no-line-numbers
add_action( 'um_stripe_webhook_payload_event_init', 'um_10312023_stripe_webhook_payload_event_init ', 10, 1 )
function um_10312023_stripe_webhook_payload_event_init( $event ){
 // do something
}
```
<div class='hook-sep'></div>
...
- [ Attach a function to Stripe webhook payload](../snippets/4099d848f325bd33ca9257e24669926f)
- [ Send admin email notification](../snippets/f5a3f57fd0295a79763683f875b9320f)
