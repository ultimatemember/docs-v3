...
``` php:no-line-numbers
add_action( 'umm_stripe_status_changed', 'um_10252023_stripe_status_changed ', 10, 3 )
function um_10252023_stripe_status_changed( $status, $um_user_id, $role_cancelled ){
 // do something
}
```
<div class='hook-sep'></div>
