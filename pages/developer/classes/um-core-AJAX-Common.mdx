...
<div class="phpdocumentor-element-found-in">
    <Link href="../files/includes-core-class-ajax-common.html#source-view.14">includes/core/class-ajax-common.php</Link> : <span class="phpdocumentor-element-found-in__line">14</span>
</div>
...
<div class="phpdocumentor-element-found-in">
    <Link href="../files/includes-core-class-ajax-common.html#source-view.20">includes/core/class-ajax-common.php</Link> : <span class="phpdocumentor-element-found-in__line">20</span>
</div>
