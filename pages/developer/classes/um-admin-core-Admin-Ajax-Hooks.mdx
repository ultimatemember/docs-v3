...
<div class="phpdocumentor-element-found-in">
    <Link href="../files/includes-admin-core-class-admin-ajax-hooks.html#source-view.16">includes/admin/core/class-admin-ajax-hooks.php</Link> : <span class="phpdocumentor-element-found-in__line">16</span>
</div>
...
<div class="phpdocumentor-element-found-in">
    <Link href="../files/includes-admin-core-class-admin-ajax-hooks.html#source-view.22">includes/admin/core/class-admin-ajax-hooks.php</Link> : <span class="phpdocumentor-element-found-in__line">22</span>
</div>
