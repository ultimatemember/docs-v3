...
#### Source
  - <Link href="/developer/files/includes-core-class-user#source-view.1444">ultimatemember/includes/core/class-user.php</Link> <Link href="/developer/files/includes-core-class-user#source-view.1444">line 1444</Link>
