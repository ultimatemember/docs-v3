...
#### Source
  - <Link href="/developer/files/templates-password-reset#source-view.131">ultimatemember/templates/password-reset.php</Link> <Link href="/developer/files/templates-password-reset#source-view.131">line 131</Link>
