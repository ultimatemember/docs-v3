...
#### Source
  - <Link href="/developer/files/includes-core-class-user#source-view.1380">ultimatemember/includes/core/class-user.php</Link> <Link href="/developer/files/includes-core-class-user#source-view.1380">line 1380</Link>
