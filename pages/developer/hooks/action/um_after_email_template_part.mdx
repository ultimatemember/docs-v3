...
#### Source
  - <Link href="/developer/files/includes-core-class-mail#source-view.242">ultimatemember/includes/core/class-mail.php</Link> <Link href="/developer/files/includes-core-class-mail#source-view.242">line 242</Link>
