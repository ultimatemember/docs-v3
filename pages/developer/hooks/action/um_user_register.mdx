...
#### Source
  - <Link href="/developer/files/includes-core-class-user#source-view.784">ultimatemember/includes/core/class-user.php</Link> <Link href="/developer/files/includes-core-class-user#source-view.784">line 784</Link>
