...
#### Source
  - <Link href="/developer/files/includes-core-class-user#source-view.512">ultimatemember/includes/core/class-user.php</Link> <Link href="/developer/files/includes-core-class-user#source-view.512">line 512</Link>
