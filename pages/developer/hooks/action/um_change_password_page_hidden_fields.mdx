...
#### Source
  - <Link href="/developer/files/templates-password-change#source-view.32">ultimatemember/templates/password-change.php</Link> <Link href="/developer/files/templates-password-change#source-view.32">line 32</Link>
