...
#### Source
  - <Link href="/developer/files/templates-password-reset#source-view.48">ultimatemember/templates/password-reset.php</Link> <Link href="/developer/files/templates-password-reset#source-view.48">line 48</Link>
