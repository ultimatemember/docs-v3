import{_ as o,r as s,o as t,c as r,a as n,b as e,e as l,d as a}from"./app-2671d5e3.js";const d={},c=a(`<h1 id="how-to-troubleshoot-facebook-sdk-returned-an-error" tabindex="-1"><a class="header-anchor" href="#how-to-troubleshoot-facebook-sdk-returned-an-error" aria-hidden="true">#</a> How to troubleshoot Facebook: SDK returned an error</h1><p>The &quot;UM Social login - Facebook: SDK returned an error&quot; Facebook login error is usually caused by aggressive server page caching but it can be easily resolved by requesting to set up a special cache exception for Ultimate member pages.</p><p>These pages should be excluded:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/login
/register
/account/social
